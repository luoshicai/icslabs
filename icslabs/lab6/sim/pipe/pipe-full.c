...
long long gen_f_pc()
{
    return (((((((if_id_curr->icode) == (I_JMP)) & ((if_id_curr->ifun) == 
                (C_LE))) & ((id_ex_curr->icode) == (I_RMMOVQ))) & (
...
{
    return ((imem_error) ? (F_NONE) : ((if_id_next->icode) == (I_MRMOVQ))
       ? (C_LE) : (imem_ifun));
}
...
long long gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVQ) || (id_ex_curr->icode) == 
            ...
            (if_id_curr->icode) == (I_RMMOVQ)) & ((id_ex_next->srca) == 
            (id_ex_curr->destm)))) | ((I_RET) == (if_id_curr->icode) || 
...
long long gen_D_bubble()
{
    return (((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch)
              ...
              (I_RMMOVQ))) & ((mem_wb_curr->icode) == (I_MRMOVQ)))) | (!((
